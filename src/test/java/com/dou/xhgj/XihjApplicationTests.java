...
public class XihjApplicationTests {
	...
	public void testPowerTswkConusume(){
		List<PowerConusmeTswkZongInfo> powerConusmeTswkZongInfoList = powerConsumeInfoDao.getTswkConsumeByCompanyId(1);
		logger.info(String.valueOf(powerConusmeTswkZongInfoList.size()));
		for(PowerConusmeTswkZongInfo powerConusmeTswkZongInfo : powerConusmeTswkZongInfoList){
			logger.info(powerConusmeTswkZongInfo.toString());
		}
	}
