...
var drawFactory = function (divId, factoryData, max, url) {
    ...
    console.log(base+"/"+"rootSsjc?aCode=" + d.key + "&cName=" + factoryData[d.key]['companyName']);
    function clicked(d) {
        ...
        window.location.href = encodeURI(base +"/"+"userSsjc.html?aCode=" + d.key + "&cName=" + factoryData[d.key]['companyName']);
    }
